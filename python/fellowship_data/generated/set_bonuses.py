...
from ..types import MediaHandle, MediaKind, Provenance, SetBonusId, SourceAuthority
...
SET_BONUSES: tuple[SetBonus, ...] = (
    SetBonus(id=SetBonusId("Quickplay"), set_bonus_id="ItemID.SetBonus.Quickplay", numeric_id=2098, display_name="Expedition Heroism", set_count=10, description="+15% Critical Chance\n+20% Haste\n+20% Expertise\n+20% Spirit", allowed_attributes=(), icon=MediaHandle(id="T_UI_Icon_Rarity_Common", kind=MediaKind.Other, width=256, height=256), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
    SetBonus(id=SetBonusId("SetA_Percentage_DH"), set_bonus_id="ItemID.SetBonus.SetA_Percentage_DH", numeric_id=1769, display_name="Draconic Deceit", set_count=2, description="+4% Critical Strike Chance\n-15% Threat Generation", allowed_attributes=("Intellect",), icon=MediaHandle(id="T_Icon_Frost_134_BetaCropped", kind=MediaKind.Other, width=256, height=256), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
    SetBonus(id=SetBonusId("SetA_Percentage_T"), set_bonus_id="ItemID.SetBonus.SetA_Percentage_T", numeric_id=1770, display_name="Draconic Fury", set_count=2, description="+4% Critical Strike Chance\n+15% Threat Generation", allowed_attributes=("Strength", "Agility", "Intellect"), icon=MediaHandle(id="T_Icon_Frost_134_BetaCropped", kind=MediaKind.Other, width=256, height=256), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
    SetBonus(id=SetBonusId("SetA_Proc_Agility"), set_bonus_id="ItemID.SetBonus.SetA_Proc_Agility", numeric_id=677, display_name="Draconic Might", set_count=2, description="Your critical strikes have a chance (0.9 PPM) to increase your Agility by 18% for 14 seconds.", allowed_attributes=("Agility",), icon=MediaHandle(id="T_Icon_Frost_113", kind=MediaKind.Other, width=256, height=256), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
    SetBonus(id=SetBonusId("SetA_Proc_Intellect"), set_bonus_id="ItemID.SetBonus.SetA_Proc_Intellect", numeric_id=678, display_name="Draconic Might", set_count=2, description="Your critical strikes have a chance (0.9 PPM) to increase your Intellect by 18% for 14 seconds.", allowed_attributes=("Intellect",), icon=MediaHandle(id="T_Icon_Frost_113", kind=MediaKind.Other, width=256, height=256), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
    SetBonus(id=SetBonusId("SetA_Proc_Strength"), set_bonus_id="ItemID.SetBonus.SetA_Proc_Strength", numeric_id=679, display_name="Draconic Might", set_count=2, description="Your critical strikes have a chance (0.9 PPM) to increase your Strength by 18% for 14 seconds.", allowed_attributes=("Strength",), icon=MediaHandle(id="T_Icon_Frost_113", kind=MediaKind.Other, width=256, height=256), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
    SetBonus(id=SetBonusId("SetB_Percentage_HDT"), set_bonus_id="ItemID.SetBonus.SetB_Percentage_HDT", numeric_id=680, display_name="Tuzari Grace", set_count=2, description="+4% Haste\n+20% Movement Speed", allowed_attributes=("Strength", "Agility", "Intellect"), icon=MediaHandle(id="T_Icon_Fire_162_BetaCropped", kind=MediaKind.Other, width=256, height=256), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
    SetBonus(id=SetBonusId("SetB_Proc_HDT"), set_bonus_id="ItemID.SetBonus.SetB_Proc_HDT", numeric_id=681, display_name="Dark Prophecy", set_count=2, description="Your abilities have a chance (0.8 PPM) to increase your Haste by 25% for 20 seconds.", allowed_attributes=("Strength", "Agility", "Intellect"), icon=MediaHandle(id="T_Icon_Fire_162_BetaCropped", kind=MediaKind.Other, width=256, height=256), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
    SetBonus(id=SetBonusId("SetC_Percentage_D"), set_bonus_id="ItemID.SetBonus.SetC_Percentage_D", numeric_id=682, display_name="Sin Warding", set_count=2, description="+4% Expertise\n+5% Max Health", allowed_attributes=("Strength", "Agility", "Intellect"), icon=MediaHandle(id="T_Icon_Gold_147_BetaCropped", kind=MediaKind.Other, width=256, height=256), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
    ...
    SetBonus(id=SetBonusId("SetC_Proc_Agility"), set_bonus_id="ItemID.SetBonus.SetC_Proc_Agility", numeric_id=685, display_name="Torment of Bael'Aurum", set_count=2, description="+5% Agility\n\nWhen dipping below 20% Health, you are instantly healed for 40% of your maximum health. This can occur once every 180 seconds.", allowed_attributes=("Agility",), icon=MediaHandle(id="T_Icon_Gold_147_BetaCropped", kind=MediaKind.Other, width=256, height=256), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
    SetBonus(id=SetBonusId("SetC_Proc_Intellect"), set_bonus_id="ItemID.SetBonus.SetC_Proc_Intellect", numeric_id=686, display_name="Torment of Bael'Aurum", set_count=2, description="+5% Intellect\n\nWhen dipping below 20% Health, you are instantly healed for 40% of your maximum health. This can occur once every 180 seconds.", allowed_attributes=("Intellect",), icon=MediaHandle(id="T_Icon_Gold_147_BetaCropped", kind=MediaKind.Other, width=256, height=256), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
    SetBonus(id=SetBonusId("SetC_Proc_Strength"), set_bonus_id="ItemID.SetBonus.SetC_Proc_Strength", numeric_id=687, display_name="Torment of Bael'Aurum", set_count=2, description="+5% Strength\n\nWhen dipping below 20% Health, you are instantly healed for 40% of your maximum health. This can occur once every 180 seconds.", allowed_attributes=("Strength",), icon=MediaHandle(id="T_Icon_Gold_147_BetaCropped", kind=MediaKind.Other, width=256, height=256), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
    SetBonus(id=SetBonusId("SetD_Percentage_D"), set_bonus_id="ItemID.SetBonus.SetD_Percentage_D", numeric_id=1771, display_name="Death's Grasp", set_count=2, description="+4% Spirit\n+10% damage to Low Health enemies.", allowed_attributes=("Strength", "Agility", "Intellect"), icon=MediaHandle(id="LootModifier_SetBonus", kind=MediaKind.Other, width=256, height=256), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
    SetBonus(id=SetBonusId("SetD_Percentage_H"), set_bonus_id="ItemID.SetBonus.SetD_Percentage_H", numeric_id=1772, display_name="Haunting Lament", set_count=2, description="+4% Spirit\n+15% Max Mana", allowed_attributes=("Strength", "Agility", "Intellect"), icon=MediaHandle(id="LootModifier_SetBonus", kind=MediaKind.Other, width=256, height=256), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
    SetBonus(id=SetBonusId("SetD_Percentage_T"), set_bonus_id="ItemID.SetBonus.SetD_Percentage_T", numeric_id=689, display_name="Sinthara's Veil", set_count=2, description="+4% Spirit\n+10% magic damage reduction", allowed_attributes=("Strength", "Agility", "Intellect"), icon=MediaHandle(id="LootModifier_SetBonus", kind=MediaKind.Other, width=256, height=256), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
    SetBonus(id=SetBonusId("SetD_Proc_Agility"), set_bonus_id="ItemID.SetBonus.SetD_Proc_Agility", numeric_id=690, display_name="Drakheim's Absolution", set_count=2, description="Your Spirit Ability grants you Drakheim's Absolution, increasing your Agility by 20% for 20 seconds.", allowed_attributes=("Agility",), icon=MediaHandle(id="T_Icon_Energy_125", kind=MediaKind.Other, width=256, height=256), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
    SetBonus(id=SetBonusId("SetD_Proc_Intellect"), set_bonus_id="ItemID.SetBonus.SetD_Proc_Intellect", numeric_id=691, display_name="Drakheim's Absolution", set_count=2, description="Your Spirit Ability grants you Drakheim's Absolution, increasing your Intellect by 20% for 20 seconds.", allowed_attributes=("Intellect",), icon=MediaHandle(id="T_Icon_Energy_125", kind=MediaKind.Other, width=256, height=256), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
    SetBonus(id=SetBonusId("SetD_Proc_Strength"), set_bonus_id="ItemID.SetBonus.SetD_Proc_Strength", numeric_id=692, display_name="Drakheim's Absolution", set_count=2, description="Your Spirit Ability grants you Drakheim's Absolution, increasing your Strength by 20% for 20 seconds.", allowed_attributes=("Strength",), icon=MediaHandle(id="T_Icon_Energy_125", kind=MediaKind.Other, width=256, height=256), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
    SetBonus(id=SetBonusId("SetE_Percentage_HDT"), set_bonus_id="ItemID.SetBonus.SetE_Percentage_HDT", numeric_id=5638, display_name="Seal of the Heskyr", set_count=2, description="Your Gem Power is increased by 25%.", allowed_attributes=("Strength", "Agility", "Intellect"), icon=MediaHandle(id="T_Icons_Generic_Placeholder", kind=MediaKind.Other, width=128, height=128), provenance=Provenance.datamine(SourceAuthority.LEGACY_UNBOUND)),
)
